...
export const Button1: React.FC<{ startWriting: () => void }> = ({ startWriting }) =>{
  return (
    <button       onClick={startWriting}  className="relative flex h-10 sm:h-12 w-full max-w-[200px] sm:max-w-[240px] md:max-w-[260px] overflow-hidden rounded-lg p-[1px] focus:outline-none">
