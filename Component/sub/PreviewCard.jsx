...
export const PreviewCard = () => {
  return (
    <>
      ...
      <div className="relative w-full  md:min-h-0 bg-opacity-0 text-white rounded-lg shadow-lg flex flex-col md:flex-row overflow-hidden p-4 md:p-8 lg:p-12 mb-4 sm:mb-8 md:mb-10" >
        ...
        <div className="border-gray-200 border hidden md:block absolute top-0 right-80 z-20 my-30 w-90 min-h-160 md:h-60 lg:h-auto p-2 md:p-4 rounded-4xl shadow-xl shadow-gray-400">
          <Image
      ...
      <button className="relative flex h-12 sm:h-12 w-full max-w-[300px] sm:max-w-[340px] md:max-w-[460px] overflow-hidden rounded-lg p-[3px] focus:outline-none hover:mx-20 ">
